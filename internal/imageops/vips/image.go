...
func NewJp2kload(filename string, options *Jp2kloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenJp2kloadWithOptions(filename, options.Page, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
...
func NewJp2kloadSource(source *Source, options *Jp2kloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenJp2kloadSourceWithOptions(source.src, options.Page, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeJp2k, nil), nil
...
func NewSvgload(filename string, options *SvgloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenSvgloadWithOptions(filename, options.Dpi, options.Scale, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
...
func NewSvgloadSource(source *Source, options *SvgloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenSvgloadSourceWithOptions(source.src, options.Dpi, options.Scale, options.Unlimited, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeSvg, nil), nil
...
func NewTiffload(filename string, options *TiffloadOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenTiffloadWithOptions(filename, options.Page, options.Subifd, options.N, options.Autorotate, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
...
func NewTiffloadSource(source *Source, options *TiffloadSourceOptions) (*Image, error) {
	Startup(nil)
	if options != nil {
		vipsImage, err := vipsgenTiffloadSourceWithOptions(source.src, options.Page, options.Subifd, options.N, options.Autorotate, options.Memory, options.Access, options.FailOn, options.Revalidate)
		if err != nil {
			return nil, err
		}
		return newImageRef(vipsImage, ImageTypeTiff, nil), nil
