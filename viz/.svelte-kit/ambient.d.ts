...
declare module '$env/static/private' {
	...
	export const BuildLab: string;
	export const BuildLabEx: string;
	...
	export const EFC_10728_1592913036: string;
	...
	export const npm_config_init_bugs_email: string;
	export const npm_config_init_bugs_url: string;
	export const npm_config_init_license: string;
	export const npm_config_init_private: string;
	export const npm_config_init_type: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config_init_bugs_email: string;
		npm_config_init_bugs_url: string;
		npm_config_init_license: string;
		npm_config_init_private: string;
		npm_config_init_type: string;
